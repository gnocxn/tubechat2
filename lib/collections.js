...
Models.helpers({
	...
	getEmbedUrl : function(){
		let url = this.iframe_embed_revshare;
		if(this.source === 'CHATURBATE'){
			url = this.iframe_embed_revshare.match(/src\=\'(.*)\' height/)[1];
		}
		return url;
	},
	getWidthClassName : function(){
		return (this.source === 'CHATURBATE') ? 'col-md-9' : 'col-md-12';
	}
})
